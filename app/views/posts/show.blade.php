	...
	<div class="container">
		...
		<div class="col-md-10" style="margin-left:10px; margin-bottom:20px; ">
                <div class="panel-heading" >
                  <h2><a href="{{ URL::action('post-show', $post->slug) }}">{{ e($post->title) }}</a> </h2> <small><i>Created By {{ $post->user_id}}, {{ $post->published_at }}</i></small>&nbsp&nbsp&nbsp<small> <i>Comments: 15</i></small>
                </div>
