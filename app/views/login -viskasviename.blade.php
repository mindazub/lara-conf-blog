                ...
                <div class="panel panel-info" >
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-title">
                         &nbsp&nbsp<a href=""><i class="glyphicon glyphicon-home"></i></a>&nbsp&nbsp&nbsp&nbsp&nbspSign In
                        </div>
...
<input id="login-username" type="text" class="form-control" name="username" value="" placeholder="username or email">
  ...
  <!-- SIGNUPBOX or REGISTER -->

            <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="panel-title">
                        &nbsp&nbsp<a href=""><i class="glyphicon glyphicon-home"></i></a>&nbsp&nbsp&nbsp&nbsp&nbspSign Up
                        </div>
                ...
                <form id="signupform" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="password" class="form-control" name="repeat_passwd" placeholder="Repeat password">
                                </div>
                            </div>
...
<!-- FORGOTBOX -->
            ...
            <div id="forgotbox" style="display:none; margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">
               &nbsp&nbsp<a href=""><i class="glyphicon glyphicon-home"></i></a>&nbsp&nbsp&nbsp&nbsp&nbspForgot password?
                        </div>
                        <div style="float:right; font-size: 80%; position: relative; top:-20px">
